...
export default function Settings() {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        <h2 className="text-xl font-bold text-slate-900">System & API Settings</h2>
        ...
        <form onSubmit={handleSave} className="space-y-5 text-xs">
          <div>
            ...
            <input
              ...
              className="mt-1.5 w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-800 text-xs font-mono outline-none focus:ring-2 focus:ring-indigo-500/20"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="mt-1.5 w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-800 text-xs outline-none"
            >
